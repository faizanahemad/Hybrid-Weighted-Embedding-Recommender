params = {
  ...
  2: dict(n_dims=112, combining_factor=0.1,
                           collaborative_params=dict(
                               prediction_network_params=dict(lr=0.05, epochs=10, batch_size=1536,
                                                              network_depth=3,
                                                              gaussian_noise=0.02, conv_depth=2,
                                                              kernel_l2=1e-9,),
                               user_item_params=dict(gcn_lr=0.0005, gcn_epochs=10, gcn_layers=2,
                                                     gcn_kernel_l2=1e-8, gcn_batch_size=1024, conv_depth=2,
                                                     margin=1.0,
                                                     gaussian_noise=0.02,
                                                     node2vec_params=dict(num_walks=100, q=0.25)))),
